...
public class Dropdown<TEnum extends Enum, P> extends Selector<TEnum, P> implements IDropDown<TEnum, P> {
    ...
    public Dropdown(By selectLocator, By optionsNamesLocatorTemplate) {
    ...
    protected String getValueAction() {
        return new Text(selectLocator).getText();
    }
    ...
    public WebElement getWebElement() {
        return new Element(selectLocator).getWebElement();
    }
    ...
    // Not relevant
    public IElement copy(By newLocator) {
        return this;
    }
}
