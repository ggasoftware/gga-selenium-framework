...
import static com.ggasoftware.uitest.control.base.asserter.DoScreen.NO_SCREEN;
import static com.ggasoftware.uitest.control.base.asserter.DoScreen.SCREEN_ON_FAIL;
...
public class Assert {
    private static BaseChecker getAssert() {
        return new Check().doScreenshot(NO_SCREEN);
    }

    public static BaseChecker doScreenOnFail() {
        return new Check().doScreenshot(SCREEN_ON_FAIL);
    }
    ...
    public static RuntimeException exception(String message) {
        return getAssert().exception(message);
    }
