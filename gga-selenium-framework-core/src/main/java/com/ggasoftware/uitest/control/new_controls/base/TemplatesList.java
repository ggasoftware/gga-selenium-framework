...
public abstract class TemplatesList<TType extends IElement, TEnum extends Enum, P> extends Element<P> implements IVisible {
    ...
    public void setListOfElements(List<String> elementsNames) {
        this.elementsNames = elementsNames;
    }

    public void setListOfElements(TEnum enumMember) {
        this.elementsNames =
    ...
    public WebElement getWebElement() {
        return getTemplateElement().getWebElement();
    }
    ...
    public WebElement getWebElement(TEnum enumName) {
        return getElement(enumName).getWebElement();
    }
    ...
    protected List<TType> getElementsListAction() {
        try {
            return elementsNames.stream().map(this::getElement).collect(Collectors.toList());
