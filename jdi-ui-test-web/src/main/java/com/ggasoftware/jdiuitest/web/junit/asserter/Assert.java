...
import com.ggasoftware.jdiuitest.core.asserter.DoScreen;
...
import static com.ggasoftware.jdiuitest.core.asserter.DoScreen.NO_SCREEN;
...
public class Assert {
    ...
    private static BaseChecker getAssert() {
        return new Check().doScreenshot(doScreen);
    }

    public static void noScreenOnFail() {
        doScreen = NO_SCREEN;
    }
