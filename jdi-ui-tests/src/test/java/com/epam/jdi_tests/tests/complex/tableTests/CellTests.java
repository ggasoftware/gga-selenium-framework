...
public class CellTests extends InitTableTests {
    ...
    @Test
    public void getCellWithValueMatchToInColumnByName___(){
        support().clean();
    ...
    public void getCellWithValueMatchInRowByNumber(){
        ...
        Assert.areEquals(cells.get(1).columnNum(), 3, String.format("Wrong column number for element 2 match to  '[a-zA-Z, ]*log[a-zA-Z, ]*' value, expected 3, but was %d", cells.get(1).columnNum()));
