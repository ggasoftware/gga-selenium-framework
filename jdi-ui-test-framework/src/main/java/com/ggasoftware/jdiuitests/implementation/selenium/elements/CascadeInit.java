...
import static com.ggasoftware.jdiuitests.implementation.selenium.elements.BaseElement.createFreeInstance;
import static com.ggasoftware.jdiuitests.implementation.selenium.elements.MapInterfaceToElement.getClassFromInterface;
import static com.ggasoftware.jdiuitests.implementation.selenium.elements.apiInteract.ContextType.Frame;
import static com.ggasoftware.jdiuitests.implementation.selenium.elements.page_objects.annotations.AnnotationsUtil.*;
...
public abstract class CascadeInit implements IBaseElement {
    ...
    private static BaseElement createChildFromFieldStatic(Class<?> parentClass, Field field, Class<?> type) {
        ...
        if (type != null) {
            ...
            if (frameBy != null)
                instance.avatar.context.add(Frame, frameBy);
        }
        return instance;
    }
