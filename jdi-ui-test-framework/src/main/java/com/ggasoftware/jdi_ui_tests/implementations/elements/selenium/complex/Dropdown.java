...
public class Dropdown<TEnum extends Enum> extends Selector<TEnum> implements IDropDown<TEnum> {
    ...
    protected void selectAction(String name) {
        if (getLocator() != null) {
            ...
            new Select(new WebBaseElement(selectLocator).getWebElement()).selectByValue(name);
    }
    @Override
    protected void selectByIndexAction(int index) {
        if (getLocator() != null) {
            ...
            new Select(new WebBaseElement(selectLocator).getWebElement()).selectByIndex(index);
    }
    @Override
