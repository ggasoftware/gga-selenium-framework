...
import com.ggasoftware.jdi_ui_tests.core.elements.base.SetValue;
...
public class Dropdown<TEnum extends Enum> extends Selector<TEnum> implements IDropDown<TEnum> {
    ...
    protected By getSelectLocator() {
        if (selectLocator == null && getLocator() != null)
            selectLocator = getLocator();
